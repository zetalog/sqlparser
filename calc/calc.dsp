...
# Begin Custom Build - Complie $(InputName)
InputPath=.\parse.y
InputName=parse

BuildCmds= \
	BISON -d -pcalc_ -v $(InputName).y -vd -o .\$(InputName).yy.c \
	COPY .\$(InputName).yy.h .\calc_parse.h \
	

".\$(InputName).yy.c" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

".\calc_parse.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
# End Custom Build
...
".\$(InputName).ll.c" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	FLEX -Pcalc_ -o.\$(InputName).ll.c $(InputName).l
